...
| M5 Defensive / Explorer / Difficulty | 进行中 | Difficulty 首个 600 局 block 通过；200k V1 与 Teacher-assisted 50k V2 均未通过风格 smoke |
...
flank route。Teacher-assisted V2 随后通过真实 CUDA、监督覆盖、checkpoint 和
协议门，但 50k smoke 的 primary estimate 仍为负：Defensive 为 -0.0183，
Explorer 为 -0.0631，且 Explorer retention 仅 0.75。按冻结规则两者均停在
50k，没有为了追结果延长到 100k。完整负结果保留在
